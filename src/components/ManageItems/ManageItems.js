...
const ManageItems = ({ item }) => {
  ...
  const deleteItem = (id) => {
    ...
    if (proceed) {
      ...
      const url = `https://fitness-warehouse-server-1.onrender.com/items/${id}`;
      fetch(url, {
        method: "DELETE",
      })
        .then((res) => res.json())
  ...
  return (
    <div className="mt-3">
      <table className="text-left w-full">
        ...
        <tbody className="bg-grey-light text-gray-900 flex flex-col items-center justify-between overflow-y-scroll w-full">
          <tr className="flex w-full mb-4">
            ...
            <td className="p-4 w-1/4">
              ...
              <button
                ...
                type="button"
                className="mx-2  focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
                Delete
              </button>
            </td>
