...
const InventoryDetails = () => {
  ...
  useEffect(() => {
    const url = `https://fitness-warehouse-server-1.onrender.com/items/${inventoryId}`;
    // console.log(url);
    fetch(url)
      .then((res) => res.json())
  ...
  return (
    <div className="">
      <h2 className="mt-2 text-rose-700 text-4xl text-center">
      ...
      <div className="mt-10 mb-10  mx-auto flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-green-400 dark:border-gray-700 dark:bg-rose-700 dark:hover:bg-green-700">
        <img
          className="object-cover w-50 h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
          src={inventory.image}
          alt=""
        ></img>
      ...
      >
        <div className="flex items-center border-b border-teal-500 py-2">
          {/* <input className="appearance-none bg-transparent border-none w-full text-gray-100 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" name='add' placeholder="Add number of your item" /> */}
          <input
            ...
            type=" number"
            name="add"
            placeholder="Add the number of your item"
            required
          />
